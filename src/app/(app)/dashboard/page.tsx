  ...
  return (
    <div>
      ...
      <Card className="mt-8">
        ...
        <p className="mt-3 text-white/60">Next.js App Router and API routes connect Better Auth/Cognito, Aurora PostgreSQL through Drizzle, Bedrock company OS generation, Polly voice playback, Transcribe jobs, and the database-backed decision ledger.</p>
      </Card>
    </div>
  );
}
